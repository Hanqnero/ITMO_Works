...
func = lambda x: np.sin(2*x)*np.cos(x)
...
for N in [2,3,4,27,50]:
    ...
    fig.savefig(f'../fig/odd/N{N}.svg', format='svg', bbox_inches='tight')
    ...
    fig.savefig(f'../fig/odd/N{N}-comp.svg', format='svg', bbox_inches='tight')
