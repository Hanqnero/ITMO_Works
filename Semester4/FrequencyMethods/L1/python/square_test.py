...
a, b = 5, 3
T = t2 - t0
func = lambda x: a if t0 <= x % T < t1 else b
...
for N in [2,3,4,27,50]:
    ...
    fig.savefig(f'../fig/square/N{N}.svg', format='svg', bbox_inches='tight')
    ...
    fig.savefig(f'../fig/square/N{N}-comp.svg', format='svg', bbox_inches='tight')
